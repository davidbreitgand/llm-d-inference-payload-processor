...
// the value stored on the Model's AttributeMap under TokenPricesAttributeKey,
// allowing producers to update both fields atomically and consumers to fetch
// both with one Get call.
